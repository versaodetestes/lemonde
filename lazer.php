	...
	<div class="container">
		<div class="row justify-content-center">
				<div class="title-group">
					...
					<p>São 12 itens de lazer e 5 itens de funcionalidades <br>
					para aproveitar ao máximo os recursos do seu residencial.</p>
				</div>
		</div>
		<div class="row justify-content-center">
		...
		<div class="row justify-content-center">
			<div class="col-md-8 text">
				...
				<p>
					Seus eventos serão inesquecíveis no salão de festas ao lado da praça do bosque e manter a forma e a saúde em dia vai ser mais prático e gostoso com a ampla academia multifuncional, entregue já equipada. Além da quadra recreativa para a prática de esportes, você pode se exercitar na quadra de tênis oficial– todas com iluminação noturna.
				</p>
				<p>
