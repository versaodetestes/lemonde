...
São quatro versões de plantas na mesma metragem, porque morar com inteligência é otimizar espaços com sofisticação.
	...
	<div class="container-fluid">
		<div class="row reveal">
			<picture>
				<source media="(max-width: 960px)" srcset="assets/banners/Banners-imagens-internas-aptos-mobile-42.jpg" class="img-fluid">
			...
			<div class="download-plantas-wrap">
				...
				<div class="download-form">
					<form class="form" action="https://www.rdstation.com.br/api/1.2/conversions"  method="POST" onSubmit=" swal('Sucesso!', 'Email enviado com sucesso! Em breve você receberá um email com o link para download.', 'success');" id="plantasdownload">
						...
						<input type="hidden" name="identificador" value="LP - Le Monde - Apto. 48m² Planta" />
						...
						<input type="hidden" name="redirect_to" value="https://lemonde.crbconstrutora.com.br/apartamento-48" />
