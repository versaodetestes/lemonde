			...
			<span class="line line-full line-blue line-mr-bottom"></span>
					...
					<div class="col-md-3  col-6">
						<ul class="nav-footer">
							...
							<li><a href="./apartamento-duplex-129">Duplex 129m²</a></li>
							<li><a href="./apartamento-62">Apto. 62m²</a></li>
							<li><a href="./apartamento-48">Apto. 48m²</a></li>
						</ul>
					</div>
					<div class="col-md-5 ml-md-auto text-center">
						<div class="about-company">
							<img src="assets/img/logo-crb.svg" class="logo-crb-footer ">
							<p>
